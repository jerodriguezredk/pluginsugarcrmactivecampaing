...
require_once('modules/'.$currentModule.'/license/SugarActiveOutfittersLicense.php');

if($_REQUEST['method'] == 'validate') {
    SugarActiveOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    SugarActiveOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    SugarActiveOutfittersLicense::add();
    ...
    $validate_license = SugarActiveOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = SugarActiveOutfittersLicense::doValidate($currentModule);
